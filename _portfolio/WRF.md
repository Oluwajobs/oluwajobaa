...
I have already done this part (hopefully correctly), so I'll write a page on this some other day if I need to reinstall it.

## Running a case study in WRF.

### Step 1: METGRID. Meteorological Reanalysis Data to guide the simulation.
