...
| **Paradox of expansion vs densification for reducing extreme urban heat** <br> <br>  such as extreme heat. As a result, there is an increasing scientific interest in the influence of diverse urban morphologies on UHI. Here, we build upon the multi-scale framework of intra-urban heat islets and investigate the impact of expansion (sprawl) vs densification of cities on the emergence of extreme heat islets. We find that a sprawling configuration is favorable for reducing the mean temperature of a city. However, for the same mean SUHI intensity, it also results in higher local thermal extremes.  <br> <br> Read more: [[EarthArXiv Preprint](https://eartharxiv.org/gxj9m/)] [In review with Scientific Reports] | <img src="/assets/images/NSR_pic2.png" width="1800px" alt="NSR"> |
